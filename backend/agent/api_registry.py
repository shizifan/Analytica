...
ALL_ENDPOINTS: tuple[ApiEndpoint, ...] = (
    ...
    ApiEndpoint(name="getThroughputAnalysisByYear", path="/api/gateway/getThroughputAnalysisByYear", domain="D1",
        ...
        analysis_note="月度序列，约16行，可直接绘制当年vs上年折线图"),
    ...
    ApiEndpoint(name="getOilsChemBreakBulkByBusinessType", path="/api/gateway/getOilsChemBreakBulkByBusinessType", domain="D1",
        ...
        tags=('油化品', '散杂货', '港区', '月度'),
        required=(), optional=('flag', 'dateMonth', 'businessType'),
        param_note="flag=0当月/1同比/2环比",
    ...
    ApiEndpoint(name="getTrendChart", path="/api/gateway/getTrendChart", domain="D2",
        ...
        analysis_note="必填businessSegment+startDate+endDate，返回throughput/businessSegment/dateMonth"),
    ...
    ApiEndpoint(name="getCustomerFieldAnalysis", path="/api/gateway/getCustomerFieldAnalysis", domain="D3",
        ...
        chain_with=("getCustomerTypeAnalysis",),
        analysis_note="返回field/count/ratio行业维度"),
    ...
    ApiEndpoint(name="getCurContributionRankOfStrategicCustomer", path="/api/gateway/getCurContributionRankOfStrategicCustomer", domain="D3",
        ...
        analysis_note="返回rank/clientName/throughput/contributionRate"),
    ...
    ApiEndpoint(name="getInvestPlanByYear", path="/api/gateway/getInvestPlanByYear", domain="D6",
        ...
        chain_with=("getCostProjectFinishByYear", "getPlanFinishByZone"),
        analysis_note="7行2019-2025，包含finishInvestAmt/planInvestAmt等，可做趋势折线"),
    ApiEndpoint(name="getCostProjectFinishByYear", path="/api/gateway/getCostProjectFinishByYear", domain="D6",
        intent="查询近5年成本性项目完成情况",
        time="T_HIST", granularity="G_ZONE",
        tags=('成本项目', '历年完成', '成本投资'),
        required=(), optional=('ownerLgZoneName',),
        param_note="",
        returns="dateYear/projectQty/realFinishPayAmt/costApplyInvestAmt",
        disambiguate="",
    ...
    ApiEndpoint(name="getCostProjectCurrentStageQtyList", path="/api/gateway/getCostProjectCurrentStageQtyList", domain="D6",
        intent="查询成本性项目当前阶段数量（立项/招标/施工/竣工等）",
        time="T_YR", granularity="G_ZONE",
        tags=('项目阶段', '施工阶段', '进度'),
        required=(), optional=('currYear', 'ownerLgZoneName'),
        param_note="",
        returns="projectQty/projectCurrentStage/ownerLgZoneName",
        disambiguate="",
